...
/**
 * <code>IconsFactory</code> provides a consistent way to access icon resource in any simplehdr.
 * <p/>
 * Any simplehdr usually need to access image files. One way to do it is to put those image files in the installation
 ...
 * <p/>
 * We also suggest you to use the template below to create a number of IconsFactory classes in your simplehdr. The
...
public class IconsFactory {
     ...
     * because we want you to make sure all image files are there in your simplehdr. If you ever see the error

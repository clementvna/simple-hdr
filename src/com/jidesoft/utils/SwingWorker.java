 ...
 * <p/>
 * <p/>
 * When writing a multi-threaded simplehdr using Swing, there are two constraints to keep in mind: (refer to <a
 * href="http://java.sun.com/docs/books/tutorial/uiswing/misc/threads.html"> How to Use Threads </a> for more details):
 * <ul> <li> Time-consuming tasks should not be run on the <i>Event Dispatch Thread</i>. Otherwise the simplehdr
 ...
 * <p/>
 * <p/>
 * These constraints mean that a GUI simplehdr with time intensive computing needs at least two threads:  1) a thread

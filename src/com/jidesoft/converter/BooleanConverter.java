...
public class BooleanConverter implements ObjectConverter {
    ...
    public Object fromString(String string, ConverterContext context) {
        ...
        if (string.equalsIgnoreCase("true")) { // in case the simplehdr runs under different locale, we still consider "true" is true.
            return Boolean.TRUE;
        }
        ...
        if (string.equalsIgnoreCase("false")) { // in case the simplehdr runs under different locale, we still consider "false" is false.
            return Boolean.FALSE;
        }
        else {
            return null;
